...
public class Mana_Weapon extends Weapon {
	...
	private static int ablt2Dmg = 25, ablt2Knck = 8, qntSpcShots;
	...
	public void Dash() {
		...
		if (md1) {
			...
			if (timeDash % 10 == 0) {
				Game.entities.add(new AE_Animation(Game.player.getX(), Game.player.getY(), 16, 16, null, 20, 0, 1, 192, 128, 16, 16, "goToUp_1"));
			}
			if (timeDash % 15 == 0) {
				Game.entities.add(new AE_Animation(Game.player.getX(), Game.player.getY() + 6, 16, 16, null, 20, 0, 1, 192, 128, 16, 16, "goToUp_2"));
				Game.entities.add(new AE_Animation(Game.player.getX() + 8, Game.player.getY() + 6, 16, 16, null, 20, 0, 1, 192, 128, 16, 16, "goToUp_2"));
			}
			timeDash++;
